...
## Feature Behavior Specifications — Phase 3 (Weekly Gameplay) — Version 1.2

**Document Status:** Baseline Feature Specifications
**Version:** 1.2
**Inputs:**
- Business Requirements Document v1.10 — authoritative business rules (BR-001…BR-320)
- Architecture and Domain Model v1.8 — aggregates, invariants, module map
- Epic and Feature Backlog v1.2 — feature list, dependencies, build sequence
- Feature Behavior Specifications (Phase 1) v1.1 and (Phase 2) v1.2 — hard dependencies

**Scope:** EPIC-007 (Gameweek Roster: F-007.1–F-007.4, plus F-007.5 added in this version), EPIC-008 (Scoring Engine: F-008.1–F-008.5), EPIC-009 (H2H Competition: F-009.1–F-009.4), and EPIC-010's remaining features (Standings & Tie-Breaks: F-010.1, F-010.2, F-010.4 — F-010.3, Season Goal Prediction submission, was already specified in Phase 1). Backlog positions 26–41, plus 55 (F-007.5, appended to the Backlog after this phase's original numbering was finalized).
