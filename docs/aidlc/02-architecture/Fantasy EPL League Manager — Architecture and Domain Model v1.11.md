...
## Architecture and Domain Model — Version 1.11

**Document Status:** Baseline Architecture
**Version:** 1.11
**Inputs:**
- Business Requirements Document v1.13 (`Fantasy EPL League Manager — Business Requirements Document v1.13.md`) — authoritative business rules (BR-001…BR-326)
