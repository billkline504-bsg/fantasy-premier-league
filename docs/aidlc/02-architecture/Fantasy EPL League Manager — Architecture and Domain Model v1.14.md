...
## Architecture and Domain Model — Version 1.14

**Document Status:** Baseline Architecture
**Version:** 1.14
**Inputs:**
- Business Requirements Document v1.16 (`Fantasy EPL League Manager — Business Requirements Document v1.16.md`) — authoritative business rules (BR-001…BR-337)
