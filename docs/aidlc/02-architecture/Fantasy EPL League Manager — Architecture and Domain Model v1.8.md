...
## Architecture and Domain Model — Version 1.8

**Document Status:** Baseline Architecture
**Version:** 1.8
**Inputs:**
- Business Requirements Document v1.10 (`Fantasy EPL League Manager — Business Requirements Document v1.10.md`) — authoritative business rules (BR-001…BR-320)
