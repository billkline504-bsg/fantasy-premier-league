...
## Architecture and Domain Model — Version 1.6

**Document Status:** Baseline Architecture
**Version:** 1.6
**Inputs:**
- Business Requirements Document v1.8 (`Fantasy EPL League Manager — Business Requirements Document v1.8.md`) — authoritative business rules (BR-001…BR-309)
