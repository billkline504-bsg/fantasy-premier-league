...
## Architecture and Domain Model — Version 1.10

**Document Status:** Baseline Architecture
**Version:** 1.10
**Inputs:**
- Business Requirements Document v1.12 (`Fantasy EPL League Manager — Business Requirements Document v1.12.md`) — authoritative business rules (BR-001…BR-325)
