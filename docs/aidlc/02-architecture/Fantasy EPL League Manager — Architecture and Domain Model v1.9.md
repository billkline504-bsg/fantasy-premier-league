...
## Architecture and Domain Model — Version 1.9

**Document Status:** Baseline Architecture
**Version:** 1.9
**Inputs:**
- Business Requirements Document v1.11 (`Fantasy EPL League Manager — Business Requirements Document v1.11.md`) — authoritative business rules (BR-001…BR-322)
