...
## Architecture and Domain Model — Version 1.2

**Document Status:** Baseline Architecture
**Version:** 1.2
**Inputs:**
- Business Requirements Document v1.5 (`Fantasy EPL League Manager — Business Requirements Document v1.5.md`) — authoritative business rules (BR-001…BR-297)
...
This document does not restate business rules; it cites them by ID (`BR-###`) and adds the structural decisions needed to implement them. Where the BRD (v1.5) and the earlier Domain Specification (v1.0) differ, **the BRD is authoritative** (it is the later, more detailed baseline — see BRD §60, "Final Baseline"). Section 2 reconciles the two.
