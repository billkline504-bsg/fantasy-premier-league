...
## Architecture and Domain Model — Version 1.12

**Document Status:** Baseline Architecture
**Version:** 1.12
**Inputs:**
- Business Requirements Document v1.14 (`Fantasy EPL League Manager — Business Requirements Document v1.14.md`) — authoritative business rules (BR-001…BR-328)
