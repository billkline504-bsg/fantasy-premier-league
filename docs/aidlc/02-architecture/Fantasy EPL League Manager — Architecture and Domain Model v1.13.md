...
## Architecture and Domain Model — Version 1.13

**Document Status:** Baseline Architecture
**Version:** 1.13
**Inputs:**
- Business Requirements Document v1.15 (`Fantasy EPL League Manager — Business Requirements Document v1.15.md`) — authoritative business rules (BR-001…BR-335)
